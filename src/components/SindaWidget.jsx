...
export default function SindaWidget() {
  ...
  if (!notice) return null  // nic nezobrazovat pokud Šinďa nic nepřidal
    ...
    <div style={{ background: 'rgba(232,160,32,0.07)', border: '1px solid rgba(232,160,32,0.2)', borderRadius: '16px', padding: '16px' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {!open && <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', background: 'rgba(255,255,255,0.06)', borderRadius: '10px', padding: '2px 8px' }}>nové</span>}
        </div>
