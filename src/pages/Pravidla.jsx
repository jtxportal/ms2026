...
Jinými slovy — peníze se pouze přerozdělí od těch, kteří fotbalu rozumí méně, k těm, kterým Pánbůh nadělil lepší fotbalový odhad.`
  },
  {
    ...
    icon: '🎯',
    color: '#e8a020',
    text: 'Každý registrovaný účastník může tipovat přesné výsledky jednotlivých zápasů. Tipuje se vždy přesný výsledek po základní hrací době. Prodloužení ani penalty se nezapočítávají.'
  },
  {
    title: 'Výše sázek',
    icon: '💰',
  ...
  {
    title: 'Převod nevyhraného banku (Jackpot)',
    icon: '🎰',
    color: '#c41230',
    text: 'Pokud žádný účastník netrefí přesný výsledek zápasu, bank se nepřerozděluje. Celá částka se automaticky převádí do jackpotu a přidá se k banku dalšího zápasu. Vítězové tak budou hrát o vyšší částku.'
  },
  {
    title: 'Úprava tipu',
    icon: '✏️',
  ...
  },
  {
    ...
    icon: '💳',
    color: '#e8a020',
    text: 'Registrací do soutěže účastník potvrzuje, že po skončení mistrovství uhradí svůj případný záporný zůstatek. Organizátoři garantují, že všechny prostředky budou spravedlivě přerozděleny přesně podle výsledků soutěže. Nikdo z organizátorů si z vložených prostředků neodečítá žádnou provizi ani odměnu.'
  },
]
    ...
    <div style={{ maxWidth: '600px', margin: '0 auto', paddingBottom: '40px' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, rgba(0,180,200,0.1), rgba(232,160,32,0.1))', border: '1px solid rgba(232,160,32,0.3)', borderRadius: '16px', padding: '16px 20px', marginBottom: '20px', textAlign: 'center' }}>
        <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.85)', fontStyle: 'italic', lineHeight: 1.7, margin: 0 }}>
          „Peníze se pouze přerozdělí od těch, kteří fotbalu rozumí méně, k těm, kterým Pánbůh nadělil lepší fotbalový odhad."
        </p>
      </div>
      ...
      {/* Footer */}
      <div style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#e8a020', fontWeight: 700 }}>
