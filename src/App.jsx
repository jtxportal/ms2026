    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/zapasy" element={
            <AppShell><Calendar /></AppShell>
          } />
          <Route path="/zapas/:id" element={
            <AppShell><MatchDetail /></AppShell>
          } />
          <Route path="/tip/:id" element={
            <AppShell><BetForm /></AppShell>
          } />
          <Route path="/zebricek" element={
            <AppShell><Leaderboard /></AppShell>
          } />
          <Route path="/chat" element={
            <AppShell><TournamentChat /></AppShell>
          } />
          <Route path="/dlouhodoby" element={
            <AppShell><LongtermBets /></AppShell>
          } />

          {/* Admin – navíc vyžaduje je_admin = true */}
